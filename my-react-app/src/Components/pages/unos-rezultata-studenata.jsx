    ...
    <div>
        <main style={{marginBottom: '100px'}}>
          ...
          <div className='cardListContainer'>
            ...
            <StudentsResultsInput student={student1}/>
            <StudentsResultsInput student={student2}/>
            <StudentsResultsInput student={student3}/>
            <StudentsResultsInput student={student4}/>
          </div>
          <div className='bottomButtons'>
              <Button variant="contained" color="primary">Spremi</Button>
              <Button variant="contained" color="error">Odustani</Button>
        </div>
        </main>
    </div>
  );
